...
export const metadata: Metadata = {
  title: "SaaSFlow - Streamline Your Business Operations",
  description: "Automate workflows, gain real-time insights, and scale your business with SaaSFlow. Start your free trial today with no credit card required.",
  keywords: ["SaaS platform", "business automation", "analytics dashboard", "workflow management", "cloud infrastructure"],
  metadataBase: new URL("https://saasflow.example.com"),
  alternates: {
    canonical: "https://saasflow.example.com"
  },
  openGraph: {
    title: "SaaSFlow - Streamline Your Business Operations",
    description: "Automate workflows, gain real-time insights, and scale your business with SaaSFlow.",
    url: "https://saasflow.example.com",
    siteName: "SaaSFlow",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763801572301-n5wxi3ci.jpg",
  ...
  twitter: {
    ...
    title: "SaaSFlow - Streamline Your Business Operations",
    description: "Automate workflows and scale your business with our powerful SaaS platform.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763801572301-n5wxi3ci.jpg"]
  },
  robots: {
    index: true,
    follow: true
